            ...
            if (lambdaMethods.get(invoke_dynamic.index1)) { // lambda invocation found
              ...
              if ("l2/gameserver/model/Creature".equals(cl.qualifiedName)) {
                DecompilerContext.getLogger().writeMessage(
                  "=== DEBUG: Creating lambda ClassNode for: " + cl.qualifiedName + " ===", 
                  IFernflowerLogger.Severity.WARN);
                DecompilerContext.getLogger().writeMessage(
                  "Lambda details - content_class: " + content_method_handle.className + 
                  ", content_method: " + content_method_handle.elementName + 
                  ", content_descriptor: " + content_method_handle.descriptor, 
                  IFernflowerLogger.Severity.WARN);
                DecompilerContext.getLogger().writeMessage(
                  "Lambda class: " + lambda_class_name + ", lambda_method: " + lambda_method_name, 
                  IFernflowerLogger.Severity.WARN);
              }
